...
import ProjectsInvestTools from './ProjectsInvestTools.jsx';
...
import Killercoda from './Killercoda.jsx';
  ...
  <React.StrictMode>
    ...
    <HashRouter>
      <Routes>
        ...
        <Route path="/projects/invest-tools" element={<ProjectsInvestTools />} />
        ...
        <Route path="/killercoda" element={<Killercoda />} />
      </Routes>
      <Footer />
    </HashRouter>
  </React.StrictMode>
