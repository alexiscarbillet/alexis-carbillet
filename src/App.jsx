...
const experiences = [
  { id: 1, title: "DevSecOps at ARTM", date: "2025-07", description: "Manage and synchronize RBAC between Azure and GCP infrastructures using python and github actions.\n Create Kubernetes cluster hosting the company observability stack (Grafana, Prometheus, …) as well as creating a Status dashboard showing the state of each product as well as its SLI/SLO/Error budget." },
